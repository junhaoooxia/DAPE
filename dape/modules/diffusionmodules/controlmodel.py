...
from dape.modules.attention import BasicTransformerBlock, SpatialTransformer, SpatialTransformerCA, SpatialTransformer3DCA
from dape.modules.diffusionmodules.openaimodel import (
...
class ControlNet3D(UNetModel3D):
    ...
    def setup_disbale_temporal(self):
        from dape.util import torch_dfs
        from dape.modules.diffusionmodules.openaimodel import (
            ResBlock3D,
            Upsample3D,
            Downsample3D,
        )
        from dape.modules.attention import SpatialTransformer3D
